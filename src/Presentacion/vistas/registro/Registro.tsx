...
export const Registro = () => {
    const { nombre, apellido, email, telefono, password, confirmarPassword, onChange, registro,errorMensaje,isValidForm } = useViewModel();
useEffect(() => {
    if (errorMensaje!= '') {
            ...
            <View style={styles.form}>
                <ScrollView>
                    ...
                    <View style={{ marginTop: 30 }}>
                        <RounderButton text='Confirmar' onPress={() => {
                          registro()
                        }} />
                    </View>
                </ScrollView>
